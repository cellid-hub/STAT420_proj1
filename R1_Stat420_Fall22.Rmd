...
Consider the following heirachichal model:
...
take input values $\alpha$ and $\beta$ and ouput the value that the
...
simulation (like the one for 'odds') to show the following property of the limiting
distribution of the reciprocal of the sample mean
